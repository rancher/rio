...
type Create struct {
	...
	AutoScaleMinScale    int               `desc:"Minimum scale autoscaler can scale to" default:"0"`
	AutoScaleMaxScale    int               `desc:"Maximum scale autoscaler can scale to" default:"50"`
	...
	ContainerConcurrency int               `desc:"The maximum concurrent request a container can handle(autoscaling)" default:"1"`
...
func (c *Create) ToService(args []string) (*client.Service, error) {
	...
	service := &client.Service{
		...
		CapDrop:              c.CapDrop,
		Command:              args[1:],
		ContainerConcurrency: int64(c.ContainerConcurrency),
		...
		MinScale:             int64(c.AutoScaleMinScale),
		MaxScale:             int64(c.AutoScaleMaxScale),
