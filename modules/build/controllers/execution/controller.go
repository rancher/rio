...
func (e executionHandler) onChange(key string, obj *webhookv1.GitWebHookExecution) (*webhookv1.GitWebHookExecution, error) {
	...
	return obj, webhookv1.GitWebHookExecutionConditionHandled.Once(obj, func() (runtime.Object, error) {
		if obj.Spec.Branch == copiedService.Spec.Build.Branch {
			if obj.Spec.Tag != "" {
				copiedService.Spec.Build.Commit = ""
				copiedService.Spec.Build.Tag = obj.Spec.Tag
			} else {
				copiedService.Spec.Build.Commit = obj.Spec.Commit
				copiedService.Spec.Build.Tag = ""
			}
