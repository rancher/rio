...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DNSInfo) DeepCopyInto(out *DNSInfo) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DNSInfo.
func (in *DNSInfo) DeepCopy() *DNSInfo {
	if in == nil {
		return nil
	}
	out := new(DNSInfo)
