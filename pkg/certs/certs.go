...
const (
	TlsSecretName        = "rancher-certs"
	RancherWildcardCerts = "rancher-wildcard"
...
func ApplyWildcardCertificates() error {
	...
	return apply.Apply([]runtime.Object{CertificateDNS(RancherWildcardCerts, domain)}, nil, settings.RioSystemNamespace, "certificate-wildcard-dns")
}
