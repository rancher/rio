...
var clusterdomainsKind = schema.GroupVersionKind{Group: "admin.rio.cattle.io", Version: "v1", Kind: "ClusterDomain"}
...
func (c *FakeClusterDomains) Get(name string, options v1.GetOptions) (result *adminriocattleiov1.ClusterDomain, err error) {
	...
	return obj.(*adminriocattleiov1.ClusterDomain), err
}
...
func (c *FakeClusterDomains) List(opts v1.ListOptions) (result *adminriocattleiov1.ClusterDomainList, err error) {
	...
	list := &adminriocattleiov1.ClusterDomainList{ListMeta: obj.(*adminriocattleiov1.ClusterDomainList).ListMeta}
	for _, item := range obj.(*adminriocattleiov1.ClusterDomainList).Items {
