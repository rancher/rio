...
var servicesResource = schema.GroupVersionResource{Group: "rio.cattle.io", Version: "v1", Resource: "services"}

var servicesKind = schema.GroupVersionKind{Group: "rio.cattle.io", Version: "v1", Kind: "Service"}

// Get takes name of the service, and returns the corresponding service object, and an error if there is any.
func (c *FakeServices) Get(name string, options v1.GetOptions) (result *riocattleiov1.Service, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(servicesResource, c.ns, name), &riocattleiov1.Service{})

	if obj == nil {
		return nil, err
	}
	return obj.(*riocattleiov1.Service), err
}

// List takes label and field selectors, and returns the list of Services that match those selectors.
func (c *FakeServices) List(opts v1.ListOptions) (result *riocattleiov1.ServiceList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(servicesResource, servicesKind, c.ns, opts), &riocattleiov1.ServiceList{})
	...
	list := &riocattleiov1.ServiceList{ListMeta: obj.(*riocattleiov1.ServiceList).ListMeta}
	for _, item := range obj.(*riocattleiov1.ServiceList).Items {
...
func (c *FakeServices) Create(service *riocattleiov1.Service) (result *riocattleiov1.Service, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(servicesResource, c.ns, service), &riocattleiov1.Service{})
...
func (c *FakeServices) Update(service *riocattleiov1.Service) (result *riocattleiov1.Service, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(servicesResource, c.ns, service), &riocattleiov1.Service{})
...
func (c *FakeServices) UpdateStatus(service *riocattleiov1.Service) (*riocattleiov1.Service, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(servicesResource, "status", c.ns, service), &riocattleiov1.Service{})
...
func (c *FakeServices) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(servicesResource, c.ns, name), &riocattleiov1.Service{})
...
func (c *FakeServices) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &riocattleiov1.ServiceList{})
	return err
}
...
func (c *FakeServices) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *riocattleiov1.Service, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(servicesResource, c.ns, name, pt, data, subresources...), &riocattleiov1.Service{})
