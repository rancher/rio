...
import (
	...
	informers "github.com/solo-io/gloo/projects/gateway/pkg/api/v1/kube/client/informers/externalversions"
...
func (c *Factory) Gateway() Interface {
	return New(c.controllerManager, c.informerFactory.Gateway(), c.clientset)
}
