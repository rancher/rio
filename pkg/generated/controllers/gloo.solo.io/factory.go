...
import (
	...
	informers "github.com/solo-io/gloo/projects/gloo/pkg/api/v1/kube/client/informers/externalversions"
...
func (c *Factory) Gloo() Interface {
	return New(c.controllerManager, c.informerFactory.Gloo(), c.clientset)
}
