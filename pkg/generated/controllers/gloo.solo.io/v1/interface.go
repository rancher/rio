...
type version struct {
	...
	client            clientset.GlooV1Interface
}

func (c *version) Settings() SettingsController {
	return NewSettingsController(v1.SchemeGroupVersion.WithKind("Settings"), c.controllerManager, c.client, c.informers.Settingses())
}
