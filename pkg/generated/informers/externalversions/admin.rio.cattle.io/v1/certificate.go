	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.AdminV1().Certificates().List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AdminV1().Certificates().Watch(options)
			},
		},
		&adminriocattleiov1.Certificate{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *certificateInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&adminriocattleiov1.Certificate{}, f.defaultInformer)
}
