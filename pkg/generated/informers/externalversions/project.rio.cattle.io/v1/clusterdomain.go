...
import (
	...
	v1 "github.com/rancher/rio/pkg/generated/listers/project.rio.cattle.io/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ProjectV1().ClusterDomains(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ProjectV1().ClusterDomains(namespace).Watch(options)
			},
		},
		&projectriocattleiov1.ClusterDomain{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterDomainInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&projectriocattleiov1.ClusterDomain{}, f.defaultInformer)
}
