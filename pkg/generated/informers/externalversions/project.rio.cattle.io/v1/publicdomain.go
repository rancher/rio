	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ProjectV1().PublicDomains(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ProjectV1().PublicDomains(namespace).Watch(options)
			},
		},
		&projectriocattleiov1.PublicDomain{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *publicDomainInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&projectriocattleiov1.PublicDomain{}, f.defaultInformer)
}
