...
type VolumeLister interface {
	...
	List(selector labels.Selector) (ret []*v1.Volume, err error)
...
// List lists all Volumes in the indexer.
func (s *volumeLister) List(selector labels.Selector) (ret []*v1.Volume, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1.Volume))
	})
	return ret, err
}
...
type VolumeNamespaceLister interface {
	...
	Get(name string) (*v1.Volume, error)
...
// List lists all Volumes in the indexer for a given namespace.
func (s volumeNamespaceLister) List(selector labels.Selector) (ret []*v1.Volume, err error) {
...
// Get retrieves the Volume from the indexer for a given namespace and name.
func (s volumeNamespaceLister) Get(name string) (*v1.Volume, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1.Resource("volume"), name)
	}
	return obj.(*v1.Volume), nil
}
