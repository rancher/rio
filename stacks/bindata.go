...
func stacksIstioCrdStackYml() (*asset, error) {
	...
	info := bindataFileInfo{name: "stacks/istio-crd-stack.yml", size: 627, mode: os.FileMode(420), modTime: time.Unix(1543265968, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func stacksIstioStackYml() (*asset, error) {
	...
	info := bindataFileInfo{name: "stacks/istio-stack.yml", size: 3934, mode: os.FileMode(420), modTime: time.Unix(1543341647, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
