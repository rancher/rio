...
func (l *certificateLister) List(namespace string, selector labels.Selector) (ret []*v1alpha1.Certificate, err error) {
	err = cache.ListAllByNamespace(l.controller.Informer().GetIndexer(), namespace, selector, func(obj interface{}) {
		ret = append(ret, obj.(*v1alpha1.Certificate))
	})
	return
}

func (l *certificateLister) Get(namespace, name string) (*v1alpha1.Certificate, error) {
	var key string
	if namespace != "" {
		key = namespace + "/" + name
	} else {
...
func (c *certificateController) AddHandler(ctx context.Context, name string, handler CertificateHandlerFunc) {
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		...
		} else if v, ok := obj.(*v1alpha1.Certificate); ok {
...
func (c *certificateController) AddClusterScopedHandler(ctx context.Context, name, cluster string, handler CertificateHandlerFunc) {
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if obj == nil {
			return handler(key, nil)
		} else if v, ok := obj.(*v1alpha1.Certificate); ok && controller.ObjectInCluster(cluster, obj) {
			return handler(key, v)
		} else {
			return nil, nil
		}
...
func (s *certificateClient) Create(o *v1alpha1.Certificate) (*v1alpha1.Certificate, error) {
	obj, err := s.objectClient.Create(o)
	return obj.(*v1alpha1.Certificate), err
}

func (s *certificateClient) Get(name string, opts metav1.GetOptions) (*v1alpha1.Certificate, error) {
	obj, err := s.objectClient.Get(name, opts)
	return obj.(*v1alpha1.Certificate), err
}

func (s *certificateClient) GetNamespaced(namespace, name string, opts metav1.GetOptions) (*v1alpha1.Certificate, error) {
	obj, err := s.objectClient.GetNamespaced(namespace, name, opts)
	return obj.(*v1alpha1.Certificate), err
}

func (s *certificateClient) Update(o *v1alpha1.Certificate) (*v1alpha1.Certificate, error) {
...
func (s *certificateClient) Patch(o *v1alpha1.Certificate, patchType types.PatchType, data []byte, subresources ...string) (*v1alpha1.Certificate, error) {
...
func (n *certificateClient2) Create(obj *v1alpha1.Certificate) (*v1alpha1.Certificate, error) {
	return n.iface.Create(obj)
}

func (n *certificateClient2) Get(namespace, name string, opts metav1.GetOptions) (*v1alpha1.Certificate, error) {
	return n.iface.GetNamespaced(namespace, name, opts)
}

func (n *certificateClient2) Update(obj *v1alpha1.Certificate) (*v1alpha1.Certificate, error) {
...
func (n *certificateClientCache) Get(namespace, name string) (*v1alpha1.Certificate, error) {
	return n.client.controller.Lister().Get(namespace, name)
}

func (n *certificateClientCache) List(namespace string, selector labels.Selector) ([]*v1alpha1.Certificate, error) {
...
func (n *certificateClientCache) Index(name string, indexer CertificateIndexer) {
	err := n.client.controller.Informer().GetIndexer().AddIndexers(map[string]cache.IndexFunc{
		name: func(obj interface{}) ([]string, error) {
			if v, ok := obj.(*v1alpha1.Certificate); ok {
				return indexer(v)
			}
			return nil, nil
		},
...
func (n *certificateClientCache) GetIndexed(name, key string) ([]*v1alpha1.Certificate, error) {
	var result []*v1alpha1.Certificate
...
func (n *certificateLifecycleDelegate) Create(obj *v1alpha1.Certificate) (runtime.Object, error) {
	if n.create == nil {
		return obj, nil
	}
	return n.create(obj)
...
func (n *certificateLifecycleDelegate) Remove(obj *v1alpha1.Certificate) (runtime.Object, error) {
	if n.remove == nil {
		return obj, nil
	}
	return n.remove(obj)
...
func (n *certificateLifecycleDelegate) Updated(obj *v1alpha1.Certificate) (runtime.Object, error) {
	if n.update == nil {
		return obj, nil
	}
	return n.update(obj)
