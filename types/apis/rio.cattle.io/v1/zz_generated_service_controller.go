...
func (l *serviceLister) List(namespace string, selector labels.Selector) (ret []*Service, err error) {
...
func (l *serviceLister) Get(namespace, name string) (*Service, error) {
	var key string
	if namespace != "" {
		key = namespace + "/" + name
	} else {
...
func (c *serviceController) AddClusterScopedHandler(ctx context.Context, name, cluster string, handler ServiceHandlerFunc) {
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if obj == nil {
			return handler(key, nil)
		} else if v, ok := obj.(*Service); ok && controller.ObjectInCluster(cluster, obj) {
			return handler(key, v)
		} else {
			return nil, nil
		}
...
func (s *serviceClient) Create(o *Service) (*Service, error) {
	obj, err := s.objectClient.Create(o)
	return obj.(*Service), err
}

func (s *serviceClient) Get(name string, opts metav1.GetOptions) (*Service, error) {
	obj, err := s.objectClient.Get(name, opts)
	return obj.(*Service), err
}

func (s *serviceClient) GetNamespaced(namespace, name string, opts metav1.GetOptions) (*Service, error) {
	obj, err := s.objectClient.GetNamespaced(namespace, name, opts)
	return obj.(*Service), err
}

func (s *serviceClient) Update(o *Service) (*Service, error) {
...
func (s *serviceClient) Patch(o *Service, patchType types.PatchType, data []byte, subresources ...string) (*Service, error) {
...
func (n *serviceClient2) Create(obj *Service) (*Service, error) {
	return n.iface.Create(obj)
}

func (n *serviceClient2) Get(namespace, name string, opts metav1.GetOptions) (*Service, error) {
	return n.iface.GetNamespaced(namespace, name, opts)
}

func (n *serviceClient2) Update(obj *Service) (*Service, error) {
...
func (n *serviceClientCache) Get(namespace, name string) (*Service, error) {
	return n.client.controller.Lister().Get(namespace, name)
}

func (n *serviceClientCache) List(namespace string, selector labels.Selector) ([]*Service, error) {
...
func (n *serviceClientCache) GetIndexed(name, key string) ([]*Service, error) {
	var result []*Service
...
func (n *serviceLifecycleDelegate) Create(obj *Service) (runtime.Object, error) {
	if n.create == nil {
		return obj, nil
	}
	return n.create(obj)
...
func (n *serviceLifecycleDelegate) Remove(obj *Service) (runtime.Object, error) {
	if n.remove == nil {
		return obj, nil
	}
	return n.remove(obj)
...
func (n *serviceLifecycleDelegate) Updated(obj *Service) (runtime.Object, error) {
	if n.update == nil {
		return obj, nil
	}
	return n.update(obj)
