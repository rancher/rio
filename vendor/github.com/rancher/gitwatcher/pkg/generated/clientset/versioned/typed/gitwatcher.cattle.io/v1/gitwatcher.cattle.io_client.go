...
type GitwatcherV1Interface interface {
...
func NewForConfig(c *rest.Config) (*GitwatcherV1Client, error) {
	...
	return &GitwatcherV1Client{client}, nil
}

// NewForConfigOrDie creates a new GitwatcherV1Client for the given config and
