...
type version struct {
	...
	client            clientset.CertmanagerV1alpha1Interface
}

func (c *version) Certificate() CertificateController {
	return NewCertificateController(v1alpha1.SchemeGroupVersion.WithKind("Certificate"), c.controllerManager, c.client, c.informers.Certificates())
}
