...
type IssuerHandler func(string, *v1alpha1.Issuer) (*v1alpha1.Issuer, error)
...
type IssuerClient interface {
	...
	Get(namespace, name string, options metav1.GetOptions) (*v1alpha1.Issuer, error)
	List(namespace string, opts metav1.ListOptions) (*v1alpha1.IssuerList, error)
	Watch(namespace string, opts metav1.ListOptions) (watch.Interface, error)
	Patch(namespace, name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Issuer, err error)
}
...
type IssuerCache interface {
	...
	GetByIndex(indexName, key string) ([]*v1alpha1.Issuer, error)
}
...
func FromIssuerHandlerToHandler(sync IssuerHandler) generic.Handler {
	return func(key string, obj runtime.Object) (ret runtime.Object, err error) {
		var v *v1alpha1.Issuer
		if obj == nil {
			v, err = sync(key, nil)
		} else {
			v, err = sync(key, obj.(*v1alpha1.Issuer))
		}
		if v == nil {
			return nil, err
		}
...
func (c *issuerController) Updater() generic.Updater {
	return func(obj runtime.Object) (runtime.Object, error) {
		newObj, err := c.Update(obj.(*v1alpha1.Issuer))
		if newObj == nil {
			return nil, err
		}
		return newObj, err
...
func UpdateIssuerDeepCopyOnChange(client IssuerClient, obj *v1alpha1.Issuer, handler func(obj *v1alpha1.Issuer) (*v1alpha1.Issuer, error)) (*v1alpha1.Issuer, error) {
	if obj == nil {
		return obj, nil
	}
...
func (c *issuerController) Create(obj *v1alpha1.Issuer) (*v1alpha1.Issuer, error) {
	return c.clientGetter.Issuers(obj.Namespace).Create(obj)
}

func (c *issuerController) Update(obj *v1alpha1.Issuer) (*v1alpha1.Issuer, error) {
	return c.clientGetter.Issuers(obj.Namespace).Update(obj)
}

func (c *issuerController) UpdateStatus(obj *v1alpha1.Issuer) (*v1alpha1.Issuer, error) {
...
func (c *issuerController) Get(namespace, name string, options metav1.GetOptions) (*v1alpha1.Issuer, error) {
	return c.clientGetter.Issuers(namespace).Get(name, options)
}

func (c *issuerController) List(namespace string, opts metav1.ListOptions) (*v1alpha1.IssuerList, error) {
...
func (c *issuerController) Patch(namespace, name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Issuer, err error) {
...
func (c *issuerCache) Get(namespace, name string) (*v1alpha1.Issuer, error) {
	return c.lister.Issuers(namespace).Get(name)
}

func (c *issuerCache) List(namespace string, selector labels.Selector) ([]*v1alpha1.Issuer, error) {
...
func (c *issuerCache) AddIndexer(indexName string, indexer IssuerIndexer) {
	utilruntime.Must(c.indexer.AddIndexers(map[string]cache.IndexFunc{
		indexName: func(obj interface{}) (strings []string, e error) {
			return indexer(obj.(*v1alpha1.Issuer))
		},
	}))
}

func (c *issuerCache) GetByIndex(indexName, key string) (result []*v1alpha1.Issuer, err error) {
	objs, err := c.indexer.ByIndex(indexName, key)
	if err != nil {
		return nil, err
	}
	for _, obj := range objs {
		result = append(result, obj.(*v1alpha1.Issuer))
	}
	return result, nil
}

type IssuerStatusHandler func(obj *v1alpha1.Issuer, status v1alpha1.IssuerStatus) (v1alpha1.IssuerStatus, error)

type IssuerGeneratingHandler func(obj *v1alpha1.Issuer, status v1alpha1.IssuerStatus) ([]runtime.Object, v1alpha1.IssuerStatus, error)
...
func (a *issuerStatusHandler) sync(key string, obj *v1alpha1.Issuer) (*v1alpha1.Issuer, error) {
	if obj == nil {
		return obj, nil
	}
...
func (a *issuerGeneratingHandler) Handle(obj *v1alpha1.Issuer, status v1alpha1.IssuerStatus) (v1alpha1.IssuerStatus, error) {
